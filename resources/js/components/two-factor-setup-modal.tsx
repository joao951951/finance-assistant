    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'O 2FA foi ativado. Escaneie o QR code ou insira a chave no seu aplicativo autenticador.',
                buttonText: 'Fechar',
            };
        }
        ...
        return {
            ...
            description:
                'Para concluir, escaneie o QR code ou insira a chave de configuração no seu aplicativo autenticador',
            buttonText: 'Continuar',
        };
