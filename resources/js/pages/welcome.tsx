        ...
        <>
            ...
            <div className="min-h-screen bg-background text-foreground">
                ...
                <main className="mx-auto flex min-h-screen max-w-4xl flex-col items-center justify-center px-6 pt-20 text-center sm:pt-14">
                    <p className="mb-4 text-xs font-medium tracking-widest text-muted-foreground uppercase sm:mb-5">
                    ...
                    <p className="mb-8 max-w-md text-base text-muted-foreground sm:mb-10">
                        Importe extratos, visualize gastos e converse com um
                        modelo de linguagem que entende os seus próprios dados
                        financeiros.
                    </p>
                        ...
                        {[
                            {
                                title: 'Importação',
                                description:
                                    'Extratos em CSV ou PDF de qualquer banco, com detecção automática de formato.',
                            },
                            {
                                title: 'Dashboard',
                                description:
                                    'Gastos por categoria, tendências mensais e resumo do orçamento em gráficos.',
                            },
                            {
                                title: 'Chat com IA',
                                description:
                                    'Converse com um modelo de linguagem usando seus dados como contexto via RAG.',
                            },
